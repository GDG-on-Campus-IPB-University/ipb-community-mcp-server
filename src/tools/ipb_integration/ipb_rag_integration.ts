...
import { getFromCollection, queryRag } from "../../utils/retrieval/semantic-search.js";
import path from "path";

export let ipb_integration_rag_tool: Tool[] = [
    {
...
export let ipb_integration_rag = async (query: string): Promise<CallToolResult> => {

    const queryText: queryRag = { text: query };
